                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            ...
                            @endif
                        @else
                                <a id="navbarDropdown" class="nav-link" href="/dashboard" role="button"v-pre>Dashboard</a>
                                <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link" href="/home" role="button"v-pre>Table</a>
                                <li class="nav-item dropdown">
